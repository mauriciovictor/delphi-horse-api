...
uses System.SysUtils, Horse, System.Classes,System.JSON, Soap.EncdDecd;
...
//            end;
            ...
            LUploadFileInfo.base64 :=  EncodeBase64(
              fileStream.Memory,
              fileStream.Size
            );
...
begin
  ...
  begin
    ...
    LJsItem.AddPair('base64', TJSONString.Create(LFileInfo.base64));
